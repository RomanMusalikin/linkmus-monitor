...
- **История** — 24ч с 10-минутным усреднением; долгосрочная история 7д / 30д / 90д по часовым агрегатам
...
| GET | `/api/history/{name}?range=7d\|30d\|90d` | Долгосрочная история (часовые агрегаты) | Bearer токен |
