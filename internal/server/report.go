...
func buildPrompt(stats []nodeStats, period, from, to string) string {
	...
	sb.WriteString("- Каждый пункт списка ОБЯЗАТЕЛЬНО начинай с символа «- » (дефис и пробел) — это единственный способ форматирования списков\n")
	sb.WriteString("- Не используй markdown-разметку: ни ##, ни **, ни __, ни другие специальные символы кроме «- » для списков\n")
